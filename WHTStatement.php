<?php
	...
	while( $row = mysqli_fetch_assoc($res) ){
		...
		if($row['processed'] != 0 AND $row['type'] != 12){
    ...
    <div class="invoice-box">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="heading" style="text-align: left;">
                ...
                <td class="nostretch" style="font-size: 12px;">
                    Cheque # including WHT + GST Witheld
                </td>
            	...
            	?>
            		...
            		<td class="nostretch" style="font-size: 12px">
	              	...
	              	<td class="nostretch" style="font-size: 12px; text-align: right !important;">
                        <?php echo $statement['WHTamtc'];
                        $totalWHT+=$statement['WHTamtc'];

                        ?><br>

                    </td>
                        <td class="nostretch" style="font-size: 12px; text-align: right !important;">
                            <?php echo $statement['GSTamtc'];

                            $totalGST+=$statement['GSTamtc'];
                            ?><br>
            ...
            <tr class="heading">
            	...
            	<td class="nostretch" style="text-align: left !important; font-size: 12px;">Cheque Amount:<?php echo locale_number_format(round($totalCredit,2),2); ?></td>
            	<td class="nostretch" style="text-align: right !important; font-size: 12px;">WHT <?php echo locale_number_format(round($totalWHT,2),2); ?></td>
                <td class="nostretch" style="text-align: right !important; font-size: 12px;">GST withold <?php echo locale_number_format(round($totalGST,2),2); ?></td>
            </tr>
