...
if($type=='rv' && !userHasPermission($db,"create_receipt_voucher")){
    header('Location: ' . $_SERVER['HTTP_REFERER']);
    return;
}
if($type=='pv' && !userHasPermission($db,"create_pv_direct")){
    header('Location: ' . $_SERVER['HTTP_REFERER']);
    return;
}
if ($_GET['json'])
            ...
            <div class="row" style="background-color: #424242; margin-bottom: 15px; padding-bottom: 15px">
                <div class="col-md-12" align="center">
                    ...
                    <div class="col-md-12" style="margin-bottom: 15px; background-color: #424242;">
                        ...
                        <input name="" type="number"  placeholder="Amount" value="" id="amount" style="color: #424242; border:1px solid #424242; border-radius: 7px; width: 35%; padding:5px; text-align:center">
                ...
                <footer style="background:#424242; bottom:0; width:100%; text-align:center; padding: 5px">
                    Powered By&nbsp;:&nbsp;<span class="bold" style="color:#aaa;">EMGSOL</span>
                </footer>
...
<script>
    let vouchertype = "<?php echo $_GET['type']?>";
    ...
    $("#proceed").on("click", function(){
        ...
        generateBill(type,amount,ref,description,instrumentType,instrumentNo,instrumentDate,pid,partyName,partyType,
    ...
    function generateBill(type,amount,ref,description,instrumentType,instrumentNo,instrumentDate,pid,partyName,partyType,
                          dba,salesman,address1,address2,address3){
        ...
        $.post("api/generateBill.php",{
            ...
            if(res.status == "success"){
                window.location = "voucherPrint.php?orderno="+res.voucherID;
            }
        });
