...
$SQL = "INSERT INTO `supptrans`(`transno`, `type`, `supplierno`, `trandate`, `inputdate`,`ovamount`)
				VALUES ('" . $parchiDetails['transno'] . "',601,'" . $parchiDetails['svid'] . "','" . date('Y-m-d H-i-s') . "',
						'" . date('Y-m-d H-i-s') . "','" . $totalValue . "')";
DB_query($SQL, $db);
...
if ($advance != 0) {
	...
	$SQL = "INSERT INTO `banktrans`(`type`, `transno`, `bankact`, `ref`, `exrate`, `functionalexrate`,
			 		...
			 		VALUES (22,'" . $RequestNo . "',1034,'advance " . $parchiDetails['parchino'] . "',1,1,'" . date('Y-m-d H-i-s') . "',
			 				'Cash'," . (-1 * $advance) . ",'PKR')";
	DB_query($SQL, $db);
	...
	$SQL = "INSERT INTO `supptrans`(`transno`, `type`, `supplierno`, `trandate`, `inputdate`,`ovamount`)
					VALUES ('" . $RequestNo . "',22,'" . $parchiDetails['svid'] . "','" . date('Y-m-d H-i-s') . "',
						'" . date('Y-m-d H-i-s') . "','" . -1 * $advance . "')";
	DB_query($SQL, $db);
	...
	$SQL = "INSERT INTO `suppallocs`(`amt`, `datealloc`, `transid_allocfrom`, `transid_allocto`, `date`)
			 		VALUES ('" . $advance . "','" . date('Y-m-d H-i-s') . "','" . $from . "','" . $to . "','" . date('Y-m-d H:i:s') . "')";
	DB_query($SQL, $db);
}
