	      			...
	      			<thead>
	      				<tr style="background-color: #424242; color: white">
							...
							<th>Advance</th>
	      					<th>State</th>
							<th>Created By</th>
							<?php if(userHasPermission($db,"edit_outward_parchi")){ ?>
								<th>Edit</th>
							<?php } ?>
	      					<th>Print</th>
	...
	<script>
		...
		(function( $ ) {
			...
			var datatableInit = function() {
				...
				$('#datatable_length')
					.find("label")
					.html("<h3 style='margin:0; padding:0; font-variant: petite-caps;'>Outward Bazar Parchi <?php if(userHasPermission($db,'create_outward_parchi' )) echo "<a class='btn btn-success' style='font-variant-caps: normal' target='_blank' href='outwardParchi.php'>Make New</a>"; ?></h3>");
			...
			$(function() {
				...
				$.ajax({
					type: 'GET',
					url: "api/listOutwardBazarParchiApi.php",
					dataType: "json",
