...
<html>
	<head>
		...
		<title>List Outward Bazar Parchi</title>
	...
	<body>
		...
		<section class="body">
            ...
            <div style="font-size: 18px;">
                <div class="col-md-12">
                    <h2>Outward Bazaar Parchi List</h2>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        ...
                        <div  class="col-md-2"><input id="item"/></div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        ...
                        <div  class="col-md-2"><select id="state">
                                <option>All</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-2"><select id="brand">
                                <option>All</option>
    ...
    <script>
        ...
        $(".filtercase").on("click",function (e) {
            ...
            $(function() {
                ...
                $.get("api/listOutwardBazarParchiApi.php?"+filter, function(res, status){
