<?php 
	...
	foreach ($items as $item) {
		...
		$SQL = "INSERT INTO bpitems (parchino,name,quantity,listprice,discount,price,created_at,updated_at,comments)
				VALUES ('MPO-".$NIBPNo."','".addslashes($item['name'])."','".$item['quantity']."',
	...
	$data = [];
	$data['module'] = "MPO";
	$data['code'] = 'MPO-'.$NIBPNo;

	QRcode::png(json_encode($data), '../../../../qrcodes/bazar/MPO/'.$NIBPNo.'-mpoQR.png', 'L', 14, 2); 
