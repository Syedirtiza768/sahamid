...
echo '<form action="selectsalescaseanalyse.php" method="post">';
echo '<div>';
echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';


echo '<table>
<tr><td>Select according to</td><td><input type="radio" name="filtertype" value="date">Commencement Date<br/>
