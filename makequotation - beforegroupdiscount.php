<?php
	...
	if($co['count'] == 0 && isNewQuotation()){
		...
		$SQL = "INSERT INTO `salesordersip`(`salescaseref`, `debtorno`, `branchcode`, `buyername`,`fromstkloc`,`deladd1`,`deladd2`,`deladd3`,`deladd4`,`deladd5`,`deladd6`,`deliverto`,`contactphone`,`contactemail`,`shipvia`,`deliverblind`,`afterdays`,`salesperson`,`quotedate`,`confirmeddate`,`deliverydate`) 
