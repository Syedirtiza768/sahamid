...
orderno='" . $_SESSION['ExistingOrder' . $identifier] . "'";
$SQLline='SELECT MAX(lineno) as maxline FROM salesorderoptions WHERE orderno="'.$_SESSION['ExistingOrder'.$identifier].'"
		';
...
DB_query($SQLD,$db);			
 ...
 $SQL='SELECT MAX(orderlineno) as maxline FROM salesorderdetails WHERE orderno="'.$_SESSION['ExistingOrder'.$identifier].'"
			';
$result=DB_query($SQL,$db);
$row=DB_fetch_array($result);
