...
$SQL ='
CREATE TABLE IF NOT EXISTS `quotationvaluecustomer'.$_SESSION['UserID'].'` (
...
mysqli_query($db,$SQL);
$SQL ='
CREATE TABLE IF NOT EXISTS `ocvaluecustomer'.$_SESSION['UserID'].'` (
...
mysqli_query($db,$SQL);
$SQL ='
CREATE TABLE IF NOT EXISTS `dcvaluecustomer'.$_SESSION['UserID'].'` (
  `quotationvalueindex` int(11) NOT NULL,
  `salesperson` varchar(35) NOT NULL,
  `customer` varchar(40) NOT NULL,
  `value` int(11) NOT NULL
...
mysqli_query($db,$SQL);
$SQL ='
CREATE TABLE IF NOT EXISTS `customerwisesales'.$_SESSION['UserID'].'` (
...
$SQL = 'truncate quotationvaluecustomer'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);
$SQL = 'truncate ocvaluecustomer'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);
$SQL = 'truncate dcvaluecustomer'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);
$SQL = 'truncate customerwisesales'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);

$SQL = ' INSERT INTO quotationvaluecustomer'.$_SESSION['UserID'].'(customer,salesperson,value)
SELECT 
debtorsmaster.name, 
salescase.salesman,
...
$SQL = ' INSERT INTO ocvaluecustomer'.$_SESSION['UserID'].'(customer,salesperson,value)
SELECT  
debtorsmaster.name,
salescase.salesman,
...
mysqli_query($db,$SQL);
$SQL = ' INSERT INTO dcvaluecustomer'.$_SESSION['UserID'].'(customer,salesperson,value)
SELECT  
debtorsmaster.name,
salescase.salesman,
...
mysqli_query($db,$SQL);
$SQL = '
INSERT INTO customerwisesales'.$_SESSION['UserID'].'(customer,salesperson,quotationvalue,ocvalue,dcvalue)

SELECT  quotationvaluecustomer'.$_SESSION['UserID'].'.customer,quotationvaluecustomer'.$_SESSION['UserID'].'.salesperson,
quotationvaluecustomer'.$_SESSION['UserID'].'.value,
 ocvaluecustomer'.$_SESSION['UserID'].'.value,dcvaluecustomer'.$_SESSION['UserID'].'.value
 FROM quotationvaluecustomer'.$_SESSION['UserID'].' LEFT OUTER JOIN ocvaluecustomer'.$_SESSION['UserID'].'
 ON 
 quotationvaluecustomer'.$_SESSION['UserID'].'.customer=ocvaluecustomer'.$_SESSION['UserID'].'.customer
LEFT OUTER JOIN dcvaluecustomer'.$_SESSION['UserID'].'
 ON 
 quotationvaluecustomer'.$_SESSION['UserID'].'.customer=dcvaluecustomer'.$_SESSION['UserID'].'.customer
...
$(document).ready(function() {
	$(\'#example\').DataTable( {
		...
		"ajax": "server_processing_customer.php",	
		      "dom": \'Blfrtip\',
        "buttons": [
            \'copyHtml5\',
            \'excelHtml5\',
