	...
	$(document).ready(function(){
		...
		$.ajax({
			type: 'POST',
		    url: rootpath+"/oc/api/retrieveOC.php",
		    data: {orderno: order},
		    dataType: "json",
		    		...
		    		for (var index in lines) {
					    ...
					    for(var optionIndex in options){
						    ...
						    for(var itemIndex in items){
							    ...
							    var indx = items[itemIndex].ocdetailsindex;
		...
		for(index in dirtyEditors){
			...
			if(dirtyEditors[index].length > 0){
				...
				if(dEditor.editor.content.isDirty()){
					...
					$.ajax({
						type: 'POST',
					    url: rootpath+"/oc/api/saveDescription.php",
	...
	function removeitem(line, option, index, description){
		...
		function(){
		  ...
		  $.ajax({
		  	type: 'POST',
		    url: rootpath+"/oc/api/deleteItem.php",
	...
	function removeoption(line, option, voption){
		...
		function(){
		  ...
		  $.ajax({
		  	type: 'POST',
		    url: rootpath+"/oc/api/deleteOption.php",
	...
	function removeline(line, vline){
		...
		function(){
		  ...
		  $.ajax({
		  	type: 'POST',
		    url: rootpath+"/oc/api/deleteLine.php",
	...
	function updateQuantity(item,quantity){
		...
		$.ajax({
			type: 'POST',
		    url: rootpath+"/oc/api/updateItem.php",
	...
	$(document.body).on('change','.order-detailss',function(){
	    ...
	    $.ajax({
			type: 'POST',
		    url: rootpath+"/oc/api/updateOrderDetails.php",
	...
	$(document.body).on('change','.descinfo',function(){
	    ...
	    $.ajax({
			type: 'POST',
		    url: rootpath+"/oc/api/updateOption.php",
	...
	$("#checkforwarnings").click(function(e){
		...
		$.ajax({
			type: 'POST',
		    url: rootpath+"/oc/api/saveOC.php",
	...
	$("#updategroupdiscountsbutton").on('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: rootpath+'/oc/api/groupDiscount.php',
