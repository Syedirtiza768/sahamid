<?php
	...
	if(!(isset($_GET['ModifyOrderNumber']) && isset($_GET['pono']) && isset($_GET['salescaseref']))){
	...
	if(mysqli_num_rows($result) != 1){
		...
		returnErrorResult($RootPath,$salescaseref, "OC not found");
		exit;
...
<html>
	...
	<section class="body background-content">
      ...
      <h2 style="text-align:center">O<span style="font-size:17px">RDER</span> C<span style="font-size:17px">ONFIRMATION</span></h2>
      <h2 style="text-align:center; margin:0"><span style="font-size:17px">Value: <span id="totalquotationvalue"></span></span></h2>
		...
		<script src="../oc/oc.js?version=<?php echo generateRandom() ?>"></script>
