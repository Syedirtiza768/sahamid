...
$mail->Username   = "irtiza.hassan@gmail.com"; // SMTP account username

$mail->Password   = "abcd908908";        // SMTP account password

 

$mail->SetFrom('irtiza.hassan@gmail.com', 'Irtiza Hassan');

$mail->AddReplyTo("irtiza.hassan@gmail.com","Irtiza Hassan");

$mail->Subject    = "Inventory Valuation Report";

$mail->AltBody    = "To view the message, please use an HTML compatible email viewer!"; // optional, comment out and test
$body = "Inventory Valuation Report is attached here";
$mail->MsgHTML($body);

$address = "irtiza.hassan@gmail.com";

$mail->AddAddress($address, "Irtiza Hassan");
$mail->AddAddress("jamal@sahamid.com", "Jamal Nasir");
$mail->AddAttachment( $_SESSION['reports_dir'] . '/InventoryReport.pdf');      // attachment
