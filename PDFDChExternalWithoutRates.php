...
<th width = "25%"align="center"> <b>Quantity</b></th>
...
if(isOverCreditLimit($db, $TransferRowS['debtorno'],round($total))){
	include ('includes/header.inc');
...
<td width = "25%" align="center">' . ''.$TransferRowC['quantity'].'</td>
...
$pdf->writeHTML($duplicate, true, false, true, false, '');
$pdf->writeHTML($html2, true, false, true, false, '');
$pdf->writeHTML($htmlpayment, true, false, true, false, '');
