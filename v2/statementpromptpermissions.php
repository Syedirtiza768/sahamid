...
if(!userHasPermission($db, 'statement_permissions')) {
...
if(isset($_GET['json'])){
    ...
    $SQL = "SELECT can_access FROM statement_access WHERE user = '$username'";
...
?>
    <script>
        ...
        $.get("statementpromptpermissions.php?json", function(res, status){
            res = JSON.parse(res);
            table.clear().draw();
        ...
        $('#searchresults').on('change','.check',function(){
            ...
            let value = ($(this).is(":checked")) ? 1 : 0;
            $.post("api/updateStatementPermissions.php",{can_access,value,user},function(data, status){
        ...
        $(document.body).on("change", ".comment", function(){
            ...
            let value = ref.val();
            let update = true;
            $.post("statementpromptpermissions.php",{column,value,invoice,update}, function(res, status){
                if(res == "success"){
...
*/
        ...
        $(".users").on("click", function(){
            ...
            $.get("statementpromptpermissions.php?json&userID="+userID, function(res, status){
                res = JSON.parse(res);
                table.clear().draw();
                table.rows.add(res).draw();
