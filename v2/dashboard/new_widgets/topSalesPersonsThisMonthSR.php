<?php
	...
	$key = "topSalesPersonsThisMonthSR";
...
<div class="col-md-8" style="padding:0px 50px" data-code="topSalesPersonsThisMonthSR">
	<div class="card ">
		...
		<div class="card-header ">
			<h3 class="box-title">Top 5 Sales Persons SR(This Month)</h3>
		</div>
		<div class="card-body ">
			<div class="row">
				<div class="col-md-12">
