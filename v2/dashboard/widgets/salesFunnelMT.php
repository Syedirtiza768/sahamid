...
<div class="col-md-4 item" style="height:250px; overflow:auto; width:45%" data-loaded="false" data-code="salesFunnelMT">
	<link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
	<div style="position: relative; padding: 5px; background: white; color: black; cursor: pointer; z-index: 15; width:100%;">
	<?php
		if ($permission == "*") {
		?>
		<select class="js-example-basic-multiple funnelMTdata" name="states[]" multiple="multiple" style="width:95%;">
		<?php
		...
		<?php } ?>
		<span class="store-data" onclick="myFunctionFunnelMT()"><i style="color:red;" class="fa fa-search" aria-hidden="true"></i></span>
		<i class="fa fa-trash removeWidget"></i>
	</div>
	<div class="item-content" id="funnelcontmt" style="background: white; width:98.3%">
	</div>
	<script>
	...
	<script>
		$(document).ready(function() {
			...
			Highcharts.chart('funnelcontmt', {
				chart: {
					type: 'funnel',
					height: 250
				},
				title: {
					text: 'Sales Funnel MT This Month'
				},
				plotOptions: {
					series: {
						dataLabels: {
	...
	<script>
		function myFunctionFunnelMT() {
			var data = $(".funnelMTdata").val();
			...
			$.ajax({
				type: "POST",
				url: "dashboard/widgets/updated_widgets/salesFunnelMTUpdate.php",
				data: {
					salesman: salesman
				},
