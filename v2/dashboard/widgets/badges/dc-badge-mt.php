...
<div class="col-md-4 col-sm-6 col-xs-12 item" style="height:140px; overflow:auto; margin-top:8px;" data-code="dc-badge-mt"> 
	<div style="position: relative; padding: 5px; background: white; color: black; cursor: pointer; z-index: 15; width:100%">
	<?php
		if ($permission == "*") {
		?>
			<select class="js-example-basic-multiple dataDcMt" name="states[]" multiple="multiple" style="width:90%;">
				<?php
		...
		<?php } ?>
		<span class="store-data" onclick="searchDcMt()"><i style="color:red;" class="fa fa-search" aria-hidden="true"></i></span>
		<i class="fa fa-trash removeBadge"></i>
	</div>
  	<div class="info-box item-content">
    	<span class="info-box-icon bg-yellow"><i class="ion ion-ios-cart-outline"></i></span>
    	<div class="info-box-content">
      		<span class="info-box-text">DC MT</span>
      		<span class="info-box-number" id="DCMT"><?php echo $dcCount; ?></span>
    	</div>
  	</div>
	  ...
	  <script>
		function searchDcMt() {
			...
			$.ajax({
				type: "POST",
				url: "dashboard/widgets/badges/badge_updated/DCUpdateMt.php",
				data: {
					salesman: salesman
				},
