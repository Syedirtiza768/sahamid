...
<div class="col-md-8 item"  style="height:250px;" data-code="salesPersonSalesHistorySR">
	...
	<script>
		$(document).ready(function(){
			...
			Highcharts.chart('comparisonchartsr', {

				title: {
					text: 'Sales Person History SR'
				},
