...
<div class="col-md-4 item" style="height:250px; overflow: auto; width:45%" data-code="outstandingMT">
<link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
	<div style="position:relative; padding: 5px; background: white; color: black; cursor: pointer; z-index: 15; width:100%;">
	<?php
		if ($permission == "*") {
		?>
		<select class="js-example-basic-multiple MTdata" name="states[]" multiple="multiple" style="width:95%;">
		<?php
		...
		<?php } ?>
		<span class="store-data" onclick="myFunctionMT()"><i style="color:red;" class="fa fa-search" aria-hidden="true"></i></span>
		<i class="fa fa-trash removeWidget"></i>
	</div>
	<div id="totaloutstandingcontmt" class="item-content" style="background: white; width:98.3%"></div>
	<script>
...
<script>
		function myFunctionMT() {
			...
			$.ajax({
				type: "POST",
				url: "dashboard/widgets/updated_widgets/outstandingTotalMTUpdate.php",
				data: {
					salesman: salesman
				},
