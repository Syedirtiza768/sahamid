...
echo '<form action="selectsalescaseanalysenew.php" method="post">';
echo '<div>';
echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';

if ($_SESSION['filtertype']=='podate')
	echo '<h2>Please use commencement date filter for brandwise analysis</h2>';
echo '<table>
<tr><td>Select according to</td><td><input type="radio" name="filtertype" value="date" checked="checked">Commencement Date<br/>
<input type="radio" name="filtertype" value="podate">PO Date</td></tr>
<tr><td>Sales Cases Between</td><td> <input type="date" name="startdate" required> AND <input type="date"  name="enddate" required></td></tr>

<tr><td>Partial Customer Name</td><td> <input type="text"  name="customer"></td></tr>
<tr><td>Partial Salesperson Name</td><td> <input type="text"  name="salesperson"></td></tr>
<tr colspan="2" ><td></td><td align="center"><input type="submit"></td></tr>
';
echo '</table></form>';
