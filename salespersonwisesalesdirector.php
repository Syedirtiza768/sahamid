<?php
    ...
    if(!userHasPermission($db, 'salespersonwisesalesdirector')) {
...
?>
<h4 style="margin: 0; background: #c5bd99; text-align: center; padding: 10px;">Salespersonwise Sales Report</h4>
	<table>
		<thead class="hilight">
			<tr>
		...
		<tr>
			<?php 
				...
				if(isset($_POST['salesperson'])  && $_POST['salesperson'] != "0"){
...
$(document).ready(function() {
	$(\'#example\').DataTable( {
		...
		"ajax": "salespersonwisesalesdirectorajax.php?start='.$_POST["startdate"].'&end='.$_POST["enddate"].'&cus='.$_POST['customer'].'&customertype='.$_POST['customertype'].'&slps='.$_POST['salesperson'].'",		
		      "dom": \'Blfrtip\',
        "buttons": [
            \'copyHtml5\',
            \'excelHtml5\',
