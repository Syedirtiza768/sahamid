...
if ($myrow['typename'] == 'IGP')
{
		printf('<td><a target="_blank" href="' . $RootPath . '/StockStatus.php?StockID=%s">%s</a></td>
			...
			%s</a></td>
				...
				mb_strtoupper($myrow['stockid']),
				mb_strtoupper($myrow['mnfCode']),
				mb_strtoupper($myrow['mnfpno']),
				$myrow['typename'],
				$myrow['transno'],
				$myrow['transno'],
				$DisplayTranDate,
...
if ($myrow['typename'] == 'DC')
{
		printf('<td><a target="_blank" href="' . $RootPath . '/StockStatus.php?StockID=%s">%s</a></td>
				<td>%s</td>
				<td>%s</td>
				<td>%s</td>
				<td><a href = "PDFDC.php?RequestNo=%s">
			%s</a></td>
...
if ($myrow['typename'] == 'IGP' and $myrow['typename'] == 'OGP' and $myrow['typename'] == 'DC')
	printf('<td><a target="_blank" href="' . $RootPath . '/StockStatus.php?StockID=%s">%s</a></td>
				<td>%s</td>
				<td>%s</td>
