...
<td colspan="4" align="center">' . 'Total: Rs.'.locale_number_format($TransferRowC['quantity']*$total,2).'</td></tr>
</table></div>';
}}
...
//$pdf->writeHTML($html3, true, false, true, false, '');
 ob_end_clean();
//$pdf->OutputD($_SESSION['DatabaseName'] . '_DC_' . $_GET['DCNo'] . '.pdf');
 $pdf->Output(dirname(__FILE__).'/tempPDF/dc/'.$_GET['DCNo'].'int.pdf', 'F');
$pdf->__destruct();
echo json_encode([]);
