...
<html>
    ...
    <input type="hidden" name="grbno" id="grbno" value="<?php echo $_GET['grbno']; ?>">
	...
	<div class="overlay-content" >
	    ...
	    <h2 style="text-align:center">S<span style="font-size:17px">SEARCH</span> <span>I</span><span style="font-size:17px">TEMS</span></h2>
	...
	<section class="body background-content">
      ...
      <h2 style="text-align:center">D<span style="font-size:17px">ELIVERY</span> C<span style="font-size:17px">HALLAN</span></h2>
      <h2 style="text-align:center; margin:0"><span style="font-size:17px">Value: <span id="totalquotationvalue"></span></span></h2>
						...
						<div class="tab-content">
							...
							<div id="order-details" class="tab-pane bongastyle">
								<div class="col-md-12">
									...
									<div class="col-md-9">
										<input class="order-detailss contactperson" type="text" style="width: 300px" maxlength="25" name="contactperson" value="" title="Enter the customer's contact person name here">
									</div>
									<div class="col-md-3">
		...
		<script src="grb.js?version=<?php echo generateRandom() ?>"></script>
