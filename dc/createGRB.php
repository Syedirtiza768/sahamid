<?php
	...
	$newDCNo = GetNextTransNo(514,$db);

	$SQL = "INSERT INTO `grb`(`orderno`, `salescaseref`, `debtorno`, `branchcode`, `orddate`, `shipvia`, `deladd1`, `deladd2`, `deladd3`, `deladd4`, `deladd5`, `deladd6`, `deliverto`, `fromstkloc`, `deliverydate`, `confirmeddate`, `quotedate`, `inprogress`,`quotation`) 
