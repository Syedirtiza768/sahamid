...
echo '<form action="selectsalescasefiltered.php" method="post">';
echo '<div>';
echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';


echo '<table>
<tr><td>Sales Cases Between</td><td> <input type="date" name="startdate" > AND <input type="date"  name="enddate" ></td></tr>
...
<h4>OR</h4>
<table><tr><td>
Enter Partial Sales case reference<input type="text"  name="salescaseref">
</td></tr>
<tr align="center"><td><center><input type="submit"></center></td></tr>
</table>
