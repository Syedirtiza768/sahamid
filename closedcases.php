<?php
    ...
    if(!userHasPermission($db, 'closedcases')) {
...
?>
<h4 style="margin: 0; background: #c5bd99; text-align: center; padding: 10px;">Closed Cases</h4>
	<table>
		<thead class="hilight">
			<tr>
...
$(document).ready(function() {
	$(\'#example\').DataTable( {
		...
		"ajax": "closedcasesajax.php?start='.$_POST["startdate"].'&end='.$_POST["enddate"].'&cus='.$_POST['customer'].'&customertype='.$_POST['customertype'].'&slps='.$_POST['salesperson'].'",
		"dom": \'Blfrtip\',
        "buttons": [
            \'copyHtml5\',
            \'excelHtml5\',
