<?php
	...
	if(!userHasPermission($db,'reorder_level_ps')){
...
SELECT stockmoves.stockid, stockmoves.loccode, 
	...
	AND (stockmoves.loccode = 'HOPS' OR stockmoves.loccode = 'MTPS' OR stockmoves.loccode = 'SRPS' OR stockmoves.loccode = 'OS') GROUP BY stockmoves.stockid,loccode";
...
INSERT INTO `reorderlevel`(`categorydescription`, `stockid`,`mnfpno`, `mnfCode`, `conditionID`,`manufacturers_name`, `description`,
 ...
 AND (locstock.loccode = 'HOPS' OR locstock.loccode = 'MTPS' OR locstock.loccode = 'SRPS' OR locstock.loccode = 'OS')
";
...
$(document).ready(function() {
	$('#example').DataTable( {
		...
		"ajax": "server_processing_reorderPS.php",	
		      "dom": 'Blfrtip',
        "buttons": [
            'copyHtml5',
            'excelHtml5',
