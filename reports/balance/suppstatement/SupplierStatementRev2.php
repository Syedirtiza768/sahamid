    ...
    $(document.body).on("click",".reverse",function(){
        ...
        swal({
            ...
            function(inputVal){
                ...
                $.get("../../../corrections/chequeCorrectionVendor.php",{FormID, transno,reason},function(res, status, something){
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
            		...
            		<td class="nostretch" style="font-size: 12px">
	              	...
	              	<td class="nostretch" style="font-size: 12px">
	              		<span style="font-size: 12px">
	              			<?php echo ($statement['settled'] == 1) ? "Alloc":"NYAlloc"; ?>
	              		</span>
	              	</td>
	              	<td class="nostretch" style="font-size: 12px">
            	...
            	?>
	              	...
	              	<td></td>
                        <td></td>
	              	<td class="nostretch" style="font-size: 12px"><span style="font-size: 12px"><?php echo ($statement['settled'] == 1) ? "Paid":"Not Paid"; ?></span></td>
	              	<td></td>
	              	<td class="nostretch" style="font-size: 12px">
	                    <?php echo locale_number_format(abs(round($statement['ovamount'],2))); ?>
	              	</td>
