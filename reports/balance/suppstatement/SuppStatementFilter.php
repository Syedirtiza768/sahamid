  			...
  			<tbody>
  				<?php if(!is_array($res)) while ($customer = mysqli_fetch_assoc($res)) { ?>
  					<tr>
						...
						<td>
							<form action="SupplierStatement.php" method="post">
	...
	<script>
		(function( $ ) {
			...
			var datatableInit = function() {
				...
				$('#datatable_length').find("label").html("<span style='margin:0; padding:0; padding-right:20px; font-variant: petite-caps; font-size:2.4rem'><i class='fa fa-users' aria-hidden='true'></i> Market Place Business Statements Filter</span> ");
			};
