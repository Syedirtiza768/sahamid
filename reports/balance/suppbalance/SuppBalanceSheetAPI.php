...
while ($customer = mysqli_fetch_assoc($result)) {
    ...
    $res[8] = '
    <td class="btn-info">
                                <form action="/sahamid//shop/voucher/paymentVoucher.php" method="post" target="_blank">
                                <input type="hidden" name="FormID" value="'.$_SESSION['FormID'].'">
                                <input type="hidden" name="cust" value="'.$customer['supplierid'].'">
                                <input type="submit" value="PV" class="btn-info" style="padding: 8px; border:1px #424242 solid;">
                                </form>
                            </td>';
$res[9] = '
<td class="btn-info">
