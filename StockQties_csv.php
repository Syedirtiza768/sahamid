...
$sql = "SELECT stockmaster.stockid,stockmaster.description,stockmaster.mnfCode,stockmaster.mnfpno, SUM(quantity) FROM locstock inner join stockmaster on locstock.stockid = stockmaster.stockid GROUP BY stockmaster.stockid HAVING SUM(quantity)<>0
