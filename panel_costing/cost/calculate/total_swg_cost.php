...
$guage_value_cd = $_POST['guage_value_cd'];
...
$id = $_POST['pc_id'];
if ($guage_value_cd == "14_swg") {
    $sql = "UPDATE pc_cash_demand SET ms_sheet_budget = '" . $swg14_cost . "' WHERE pc_id = '" . $id . "'";
    mysqli_query($conn, $sql);
} elseif ($guage_value_cd == "16_swg") {
    $sql = "UPDATE pc_cash_demand SET ms_sheet_budget = '" . $swg16_cost . "' WHERE pc_id = '" . $id . "'";
    mysqli_query($conn, $sql);
} elseif ($guage_value_cd == "18_swg") {
    $sql = "UPDATE pc_cash_demand SET ms_sheet_budget = '" . $swg18_cost . "' WHERE pc_id = '" . $id . "'";
    mysqli_query($conn, $sql);
}
...
if (mysqli_query($conn, $sql)) {
    echo json_encode(array(
        "swg14_total_cost" => $swg14_total_cost, "swg14_final_cost" => $swg14_final_cost,
        ...
        "swg16_cost" => $swg16_cost, "swg18_cost" => $swg18_cost
    ));
    die;
}
