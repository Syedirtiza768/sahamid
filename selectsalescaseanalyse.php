...
SELECT COUNT(*) as quotecount,
 ...
 LEFT OUTER JOIN debtorsmaster ON salescase.debtorno = debtorsmaster.debtorno 
 WHERE
 salescase.podate!= "0000-00-00 00:00:00" AND
`commencementdate` BETWEEN "'.$_POST['startdate'].'" AND "'.$_POST['enddate'].'"

AND `name`LIKE"%'.$_POST['customer'].'%" AND `salesman`LIKE"%'.$_POST['salesperson'].'%" 
 
AND closingreason LIKE "%%"
...
$(document).ready(function() {
	$(\'#example\').DataTable( {
		...
		"ajax": "server_processing_analysis.php",	
		      "dom": \'Blfrtip\',
        "buttons": [
            \'copyHtml5\',
            \'excelHtml5\',
...
else if ($_SESSION['AccessLevel'] == 11 OR $_SESSION['AccessLevel'] == 8 OR $_SESSION['AccessLevel'] == 27)
{
echo'
<script type="text/javascript" language="javascript" class="init">
$(document).ready(function() {
...
echo "<tr><td><h3 align='left'> Total Value of Quotations having PO </h3></td><td><h3>Rs.".locale_number_format($totalpovaluerow['value'],0)."
