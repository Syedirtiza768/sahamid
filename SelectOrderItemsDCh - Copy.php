...
// everything below here only do if a customer is selected
	...
	//	echo '</b><br />' . _('Terms') . ':<b> ' . $_SESSION['Items'.$identifier]->PaymentTerms;
		...
		echo '<table border="1"><tr><td><a href="SelectOrderItemsDCh.php?identifier='.$identifier .'">Bill of Quantities</a></td><td><a href="SelectOrderItemsDChexternal.php?identifier='.$identifier .'">Descriptions</a></td></tr></table>';
