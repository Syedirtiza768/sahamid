...
// everything below here only do if a customer is selected
	...
	//	echo '</b><br />' . _('Terms') . ':<b> ' . $_SESSION['Items'.$identifier]->PaymentTerms;
		echo '</b></div>';
		echo '<table border="1"><tr><td><a href="SelectOrderItems.php?identifier='.$identifier .'" onclick="return confirm(\'' . _('Press OK only if description is saved') . '\');">Bill of Quantities</a></td><td><a style="color:green;" href="SelectOrderItemsexternal.php?identifier='.$identifier .'">Descriptions</a></td></tr></table>';
