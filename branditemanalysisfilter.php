...
echo '<form action="branditemanalysis.php" method="post">';
echo '<div>';
...
<tr><td>Analysis Between</td><td> <input type="date" name="startdate" required> AND <input type="date"  name="enddate" required></td></tr>';
...
echo '</select>';
echo '<tr colspan="2" ><td></td><td align="center"><input type="submit"></td></tr>
';
echo '</table></form>';
