...
$MenuItems['orders']['Transactions']['Caption'] = array(_(''),
...
$MenuItems['orders']['Maintenance']['Caption'] = array( _('Create Sales Case'),
														_('Select Sales Case'),
														_('Analyse Sales Cases'),
														_('Sales Data Analysis'),
														_('Sales Data Analysis(New)'),
														_('Sales Data Analysis(Director)'),
														_('Select Closed Sales Case'),
														_('Create Contract'),
														_('Select Contract'),
														_('Sell Through Support Deals'));

$MenuItems['orders']['Maintenance']['URL'] = array( '/salescase.php?NewSalesCase=Yes',
													'/selectsalescase.php',
													'/selectsalescasefilter.php',
													'/selectsalescaseanalysefilter.php',
													'/selectsalescaseanalysefilternew.php',
													'/directoranalysefilternew.php',
													'/selectsalescaseclosed.php',
													'/Contracts.php',
													'/SelectContract.php',
													'/SellThroughSupport.php');

$MenuItems['AR']['Transactions']['Caption'] = array(_('Select DC to Invoice'),
...
$MenuItems['stock']['Transactions']['Caption'] = array(	_('Receive Purchase Orders'),
														_('Inventory Transfer') . ' - ' . _('Receive'),
														_('Inventory SubStore Transfers'),
														_('Inventory Adjustments'),
														_('Reverse Goods Received'),
														_('Enter Stock Counts'),
														_('Inwards Gate Pass'),
														_('Outwards Gate Pass'),
													
														_('Create a New Stock Request'),
														_('Authorise InterStore Stock Requests'),
														_('Request Status'),
														_('Fulfill InterStore Stock Requests'));

$MenuItems['stock']['Transactions']['URL'] = array(	'/PO_SelectOSPurchOrder.php',
													
													'/StockLocTransferReceive.php',
													'/StockSubStoreTransfers.php?New=Yes',
					...
					'/igp.php?New=Yes',
													...
													'/InterStoreStockRequest.php?New=Yes',
													'/InterStoreStockRequestAuthorisation.php',
													'/requeststatus.php',
													'/InterStoreStockRequestFulfill.php');
...
$MenuItems['stock']['Reports']['URL'] = array(	'/StockSerialItemResearch.php',
												...
												'/StockLocStatus.php',
												'/cartstatus.php',
												'/reprintdocuments.php',
												'/reprintdocumentsnew.php',
...
$MenuItems['system']['Maintenance']['Caption'] = array(	_('Inventory Categories Maintenance'),
														...
														_('Price Factors Maintenance'),
														
														_('Units of Measure'),
														_('MRP Available Production Days'),
														_('MRP Demand Types'),
														_('Maintain Sub Stores'),
														_('Maintain Companies'),
