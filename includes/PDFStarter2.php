...
class MYPDF extends Cpdf {

	private $PDFFOOTTITLE = "";
	
	public function setFootTitle($title){
		$this->PDFFOOTTITLE = $title;
	}
    //Page header
    ...
    public function Footer() {
        ...
        $this->Cell(0, 10, $this->PDFFOOTTITLE.'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');

	}
}

$pdf = new MYPDF($DocumentOrientation, 'pt', $DocumentPaper, true, 'UTF-8');
...
$pdf->setHeaderFont(Array('helvetica', '', 10, '', true));
$pdf->setFooterFont(Array('helvetica', '', 8, '', true));
