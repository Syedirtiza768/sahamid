...
Class Allocation {
	...
	function add_to_AllocsAllocn ($ID, $TransType, $TypeNo, $TransDate, $AllocAmt, $TransAmount, $ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID,$settled,$taxTotal,$processed){
		// if ($AllocAmt <= ($TransAmount - $PrevAlloc)){

			$this->Allocs[$ID] = new Allocn($ID, $TransType, $TypeNo, $TransDate, $AllocAmt, $TransAmount, $ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, 
											$PrevAllocRecordID,$settled,$taxTotal,$processed);
			Return 1;
...
Class Allocn {
	...
	function Allocn ($ID, $TransType, $TypeNo, $TransDate, $AllocAmt, $TransAmount,$ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID,$settled,$taxTotal,$processed){
