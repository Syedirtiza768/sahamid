...
/* $Id: header.inc 6310 2013-08-29 10:42:50Z daintree $ */
	...
	$db=mysqli_connect('localhost','irtiza','netetech321','sahamid');
    	...
    	$SQL = 'SELECT grbdetails.orderno as grbno,dcs.orderno as dcno,stockmaster.stockid,stockmaster.mnfCode,stockmaster.mnfpno,
		stockmaster.description,manufacturers.manufacturers_name,(grbdetails.quantity) as qty,    
		debtorsmaster.name,
		salescase.salesman,grb.orddate as grbdate
		 from dcs INNER JOIN grb on
		 dcs.orderno=grb.dcno 
		 INNER JOIN grbdetails on grb.orderno = grbdetails.orderno
		 INNER JOIN salescase on salescase.salescaseref=dcs.salescaseref
		 INNER JOIN stockmaster on stockmaster.stockid=grbdetails.stkcode
