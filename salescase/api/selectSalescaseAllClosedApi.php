...
$AllowAnyone = true;
	...
	if($_SESSION['AccessLevel'] == 22 || $_SESSION['AccessLevel'] == 8 || $_SESSION['AccessLevel'] == 10){
		...
		$SQL = 'SELECT `salescaseindex`, salescase.salescaseref, `salescasedescription`,
				...
				salescase.priority, salescase.priority_updated_by,salescase.closingreason,salescase.closingremarks,salescase.closingdate FROM salescase 
	...
	while($row = mysqli_fetch_assoc($result)){
        ...
        $d['closingreason'] 		= $row['closingreason'];
        $d['closingremarks'] 		= $row['closingremarks'];
        $d['closingdate'] 		= $row['closingdate'];
