<?php
    ...
    if(!userHasPermission($db, 'opportunitypipeline')) {
...
?>
<h4 style="margin: 0; background: #c5bd99; text-align: center; padding: 10px;">Opportunity Pipeline</h4>
	<table>
		<thead class="hilight">
			<tr>
	...
	<table id="example" class="display responsive" cellspacing="0" width="100%">
		<thead>
			<tr>
				...
				<th style="width:10px">salescaseref</th>
				<th style="width:30px">salescasedescription</th>
				<th style="width:15px">salesman</th>
				<th style="width:15px">commencementdate</th>
				<th style="width:15px">debtorname</th>
				<th style="width:10px">enquiryvalue</th>
			</tr>
		</thead>
		<tfoot>
			<tr>
...
if ($_SESSION['AccessLevel'] == 10 OR $_SESSION['AccessLevel'] == 22 OR $_SESSION['AccessLevel'] == 23 OR $_SESSION['AccessLevel'] == 11 OR $_SESSION['AccessLevel'] == 8 OR $_SESSION['AccessLevel'] == 27)
{
echo'
