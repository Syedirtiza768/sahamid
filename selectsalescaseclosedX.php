...
$SQL = "truncate salescaseclosedreporting";
mysqli_query($db,$SQL);
$SQL = "truncate quotationvalue";
mysqli_query($db,$SQL);

$SQL = "
INSERT INTO quotationvalue(salescaseref,orderno,value)
...
$SQL = "
INSERT INTO `salescaseclosedreporting`(`salescaseindex`, salescaseref, `salescasedescription`,
 ...
 dclink, commentcode, quotationvalue,closingreason,closingremarks,stage,closingdate)
SELECT `salescaseindex`, salescase.salescaseref, `salescasedescription`,
 ...
 `ocdocumentfile`, `ocdocumentdate`, dispatchid, commentcode, quotationvalue.value, closingreason,
 closingremarks,stage,closingdate
 ...
 LEFT OUTER JOIN quotationvalue ON quotationvalue.salescaseref = salesorders.salescaseref
 LEFT OUTER JOIN 
 salescasecomments 
 ...
 WHERE (salescasecomments.time IN (SELECT MAX(time) FROM salescasecomments GROUP BY salescaseref)
		...
		AND 
		(quotationvalue.orderno IN (SELECT MAX(orderno) FROM salesorders GROUP BY salescaseref)
        OR quotationvalue.orderno IS NULL
...
<?php
if ($_SESSION['AccessLevel'] == 10 or $_SESSION['AccessLevel'] == 11 or $_SESSION['AccessLevel'] == 22 or $_SESSION['AccessLevel'] == 23or $_SESSION['AccessLevel'] == 27)
{
echo'
...
$(document).ready(function() {
	$(\'#example\').DataTable( {
		...
		"ajax": "server_processing_caseclosed.php",	
		      "dom": \'Blfrtip\',
        "buttons": [
            \'copyHtml5\',
            \'excelHtml5\',
