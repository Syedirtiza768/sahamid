...
$SQL ='
CREATE TABLE IF NOT EXISTS `quotationvaluesalesperson'.$_SESSION['UserID'].'` (
...
mysqli_query($db,$SQL);
$SQL ='
CREATE TABLE IF NOT EXISTS `ocvaluesalesperson'.$_SESSION['UserID'].'` (
...
mysqli_query($db,$SQL);
$SQL ='
CREATE TABLE IF NOT EXISTS `dcvaluesalesperson'.$_SESSION['UserID'].'` (
  `quotationvalueindex` int(11) NOT NULL,
  `salesperson` varchar(35) NOT NULL,
...
mysqli_query($db,$SQL);
$SQL ='
CREATE TABLE IF NOT EXISTS `salespersonwisesales'.$_SESSION['UserID'].'` (
...
$SQL = 'truncate quotationvaluesalesperson'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);
$SQL = 'truncate ocvaluesalesperson'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);
$SQL = 'truncate dcvaluesalesperson'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);
$SQL = 'truncate salespersonwisesales'.$_SESSION['UserID'].'';
mysqli_query($db,$SQL);

$SQL = ' INSERT INTO quotationvaluesalesperson'.$_SESSION['UserID'].'(salesperson,value)
SELECT  
salescase.salesman,
...
$SQL = ' INSERT INTO ocvaluesalesperson'.$_SESSION['UserID'].'(salesperson,value)
SELECT  
salescase.salesman,
...
mysqli_query($db,$SQL);
$SQL = ' INSERT INTO dcvaluesalesperson'.$_SESSION['UserID'].'(salesperson,value)
SELECT  
salescase.salesman,
...
mysqli_query($db,$SQL);
$SQL = '
INSERT INTO salespersonwisesales'.$_SESSION['UserID'].'(salesperson,quotationvalue,ocvalue,dcvalue)

SELECT  quotationvaluesalesperson'.$_SESSION['UserID'].'.salesperson,
quotationvaluesalesperson'.$_SESSION['UserID'].'.value,
 ocvaluesalesperson'.$_SESSION['UserID'].'.value,dcvaluesalesperson'.$_SESSION['UserID'].'.value
 FROM quotationvaluesalesperson'.$_SESSION['UserID'].' LEFT OUTER JOIN ocvaluesalesperson'.$_SESSION['UserID'].'
 ON 
 quotationvaluesalesperson'.$_SESSION['UserID'].'.salesperson=ocvaluesalesperson'.$_SESSION['UserID'].'.salesperson
LEFT OUTER JOIN dcvaluesalesperson'.$_SESSION['UserID'].'
 ON 
 quotationvaluesalesperson'.$_SESSION['UserID'].'.salesperson=dcvaluesalesperson'.$_SESSION['UserID'].'.salesperson
...
$(document).ready(function() {
	$(\'#example\').DataTable( {
		...
		"ajax": "server_processing_salesperson.php",	
		      "dom": \'Blfrtip\',
        "buttons": [
            \'copyHtml5\',
            \'excelHtml5\',
