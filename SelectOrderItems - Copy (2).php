...
/* This is where the order as selected should be displayed  reflecting any deletions or insertions*/
 ...
 onClick=window.open("quotationhistory.php/?stockid='.$OrderLine->StockID.'","Ratting","width=550,height=170,0,status=0,scrollbars=1");>' . $OrderLine->StockID . '</a></td>
			...
			echo '</td>
				...
				echo '<td><input class="number" type="text" readonly="readonly" required="required" name="Price_' . $OrderLine->LineNumber . '" size="16" maxlength="16" 
				value="' . locale_number_format($OrderLine->Price,2) . '" title="' . _('Enter the price to charge the customer for this item') . '" /></td>
					<td><input class="number" type="text" required="required" name="Discount_' . $OrderLine->LineNumber . '" size="5" maxlength="4"
					value="' . locale_number_format(($OrderLine->DiscountPercent * 100),2) . '" title="' . _('Enter the discount percentage to apply to the price for this item') . '" /></td>
					';
