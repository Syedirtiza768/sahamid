<?php
	...
	function reorderlines($orderno, $db){
		...
		$SQL = "SELECT * FROM oclines WHERE orderno='".$orderno."'";
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			//update line index
			$SQL = "UPDATE oclines SET lineno='".$newLineIndex."'
			...
			while($optionsRow = mysqli_fetch_assoc($lineOptionsResult)){
				...
				$SQL = "UPDATE ocdetails SET orderlineno='".$newLineIndex."'
						WHERE orderno='".$orderno."'
			...
			$SQL = "UPDATE ocoptions SET lineno='".$newLineIndex."'
					WHERE orderno='".$orderno."'
					AND lineno='".$row['lineno']."'";
