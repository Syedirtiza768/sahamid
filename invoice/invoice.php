<?php
	...
	$RootPath = explode("/invoice", $RootPath)[0];
	...
	$ModifyOrderNumber = $_GET['ModifyOrderNumber'];
	$orderno = $_GET['ModifyOrderNumber'];

	$db = createDBConnection();

	$SQL = "SELECT * FROM invoice 
			WHERE invoiceno='".$ModifyOrderNumber."'";

	$result = mysqli_query($db, $SQL);

	if(mysqli_num_rows($result) != 1){

		returnErrorResult($RootPath,$salescaseref, "Invoice not found");
		exit;
...
<html>
	...
	<input type="hidden" name="salescaseref" id="salesref" value="">
	...
	<section class="body background-content">
      ...
      <h2 style="text-align:center">I<span style="font-size:17px">NVOICE</span></h2>
						...
						<div class="tab-content">
							<div id="basic" class="tab-pane active">
								<div class="row">
								  ...
								  <div id="salescasereff" class="col-md-9">
									Loading...
								  </div>
								  <div class="col-md-3">
									Order# (Invoice):
							...
							<div id="order-details" class="tab-pane">
								<div class="col-md-12">
									<div class="col-md-3">
										Deliver To:		
									</div>
									...
									<div class="col-md-9">
										<input class="order-detailss customerref" type="text" style="width: 300px" maxlength="25" name="customerref" value="" title="Enter the PO no here">
									</div>
									<div class="col-md-3">
										PODate:
									</div>
									<div class="col-md-9">
										<input class="order-detailss podate" type="date" style="width: 300px" maxlength="25" name="podate" value="" title="Enter the PO no here">
									</div>
									<div class="col-md-3">
										Shop Invoice #:
									</div>
									<div class="col-md-9">
										<input class="order-detailss shopinvoiceno" type="text" style="width: 300px" maxlength="25" name="shopinvoiceno" value="" title="Enter the invoice no from shop or head office here">
									</div>
									<div class="col-md-3">
										Invoice Date#:
									</div>
									<div class="col-md-9">
										<input class="order-detailss invoicesdate" type="date" style="width: 300px" maxlength="25" name="invoicesdate" value="" title="Enter the invoice no from shop or head office here">
									</div>
									<div class="col-md-3">
										Due#:
									</div>
									<div class="col-md-9">
										<input class="order-detailss due" type="date" style="width: 300px" maxlength="25" name="due" value="" title="Enter the invoice no from shop or head office here">
									</div>
									<div class="col-md-3">
										Expected#:
									</div>
									<div class="col-md-9">
										<input class="order-detailss expected" type="date" style="width: 300px" maxlength="25" name="expected" value="" >
									</div>
									<!--<div class="col-md-3">
										Advance%:
									</div>
									...
									<div class="col-md-9">
										<select class="order-detailss gst" name="gst" style="width: 300px">
		...
		<script src="invoice.js?version=<?php echo generateRandom() ?>"></script>
