<?php
    ...
    if(!userHasPermission($db, 'customerwisesalesreports')) {
...
?>
	<h4 style="margin: 0; background: #c5bd99; text-align: center; padding: 10px;">Customerwise Sales Report</h4>
	<table>
		<thead class="hilight">
			<tr>
