...
$SQL = "truncate salescasereporting";
mysqli_query($db,$SQL);
...
mysqli_query($db,$SQL);
 ...
 $SQL = "
INSERT INTO `salescasereporting`(`salescaseindex`, salescaseref, `salescasedescription`,
...
SELECT `salescaseindex`, salescase.salescaseref, `salescasedescription`,
 ...
 `ocdocumentfile`, `ocdocumentdate`, dispatchid, commentcode, quotationvalue.value
