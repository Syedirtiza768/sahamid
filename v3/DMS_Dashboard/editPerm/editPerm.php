...
<body>
	...
	<div class="table-wrapper">
		<div class="table-title">
			<div class="row">
				<div class="col-sm-6">
					<b><h1 style="font-size: 23px;">Selected Users Can Edit Saved Files</b></h1><br>
				</div>
			</div>
		</div>
		<table id= "myTable" class="table table-striped table-hover">
			...
			$result1 = mysqli_query($conn,"SELECT permission FROM editPerm WHERE userid='".$row["userid"]."' ");
				while($row1 = mysqli_fetch_array($result1)) {
                    $editPerm = $row1['permission'];
            ...
            ?>
			        ...
			        <td>
						<span class="custom-checkbox">
							<input type="checkbox" class="user_checkbox" id = "<?php echo $editPerm; ?>" user-id="<?php echo $row["userid"]; ?> " checked>
            ...
            ?>
                    <td>
						<span class="custom-checkbox">
							<input type="checkbox" class="user_checkbox" id = "<?php echo $editPerm; ?>" user-id="<?php echo $row["userid"]; ?> " >
							<label for="checkbox2"></label>
						</span>
					</td>
              <?php
