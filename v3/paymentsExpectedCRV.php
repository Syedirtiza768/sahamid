<?php 
	...
	if(!userHasPermission($db, "payments_expected_report_crv")){
...
<script>
	$(document).ready(function(){
	    ...
	    $(".searchData").on("click", function(){
	    	...
	    	table.clear().draw();
	    	$.post("paymentsExpectedCRV.php",{from,to,FormID},function(res, status){
	    		res = JSON.parse(res);
