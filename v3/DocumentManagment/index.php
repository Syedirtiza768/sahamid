...
<head>
  ...
  <title>Document Mangement System</title>
    ...
    <script src="js/jquery.min.js"></script><meta name="viewport" content="initial-scale=1.0; maximum-scale=1.0; width=device-width;">
</head>
<style>
#My_word_form{
    display : none;
