<?php 
	...
	if(!userHasPermission($db, "payments_expected_report")){
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="col-md-12">
			<h1>Payments Expected Invoice</h1>
		</div>
...
<script>
	$(document).ready(function(){
	    ...
	    $(".searchData").on("click", function(){
	    	...
	    	table.clear().draw();
	    	$.post("paymentsExpected.php",{from,to,FormID},function(res, status){
	    		res = JSON.parse(res);
