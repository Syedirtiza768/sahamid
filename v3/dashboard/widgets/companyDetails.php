...
<div class="col-md-8 item" style="height:250px; overflow:auto; width:70%" data-code="companyDetails">
	<link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
	<div style="position: relative; padding: 5px; background: white; color: black; cursor: pointer; z-index: 15; width:100%;">
		<?php
		if ($permission == "*") {
		?>
			<select class="js-example-basic-multiple CDdata" name="states[]" multiple="multiple" style="width:95%;">
				<?php
		...
		<?php } ?>
		<span class="store-data" onclick="myCDFunction()"><i style="color:red;" class="fa fa-search" aria-hidden="true"></i></span>
		<i class="fa fa-trash removeWidget"></i>
	</div>
	<div id="detailscomparisonchart" class="item-content" style="width:100%; height:250px; background:white; display:flex; align-items:center; justify-content:center; cursor:pointer" data-loaded="false">
	</div>
	...
	<script>
		function myCDFunction() {
			...
			$.ajax({
				type: "POST",
				url: "dashboard/widgets/updated_widgets/compDetailUpdate.php",
				data: {
					salesman: salesman
				},
