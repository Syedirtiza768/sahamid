...
<div class="col-md-4 item" style="height:250px; overflow:auto; width:45%" data-code="unallocatedTotal">
	<link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
	<div style="position: relative; padding: 5px; background: white; color: black; cursor: pointer; z-index: 15; width:100%;">
		<?php
		if ($permission == "*") {
		?>
			<select class="js-example-basic-multiple dataUA" name="states[]" multiple="multiple" style="width:90%;">
				<?php
		...
		<?php } ?>
		<span class="store-data" onclick="myFunctionUA()"><i style="color:red;" class="fa fa-search" aria-hidden="true"></i></span>
		<i class="fa fa-trash removeWidget"></i>
	</div>
	<div id="totalunallocatedcont" class="item-content" style="background: white; width:98.3%"></div>
	<script>
	...
	<script>
		$(document).ready(function() {
			...
			Highcharts.chart('totalunallocatedcont', {
				chart: {
					type: 'funnel',
					height: 250
				},
	...
	<script>
		function myFunctionUA() {
			...
			$.ajax({
				type: "POST",
				url: "dashboard/widgets/updated_widgets/unallocatedTotalUpdate.php",
				data: {
					salesman: salesman
				},
