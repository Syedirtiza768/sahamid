...
<div class="col-md-8 item"  style="height:250px;" data-code="salesPersonSalesHistoryMT">
	...
	<script>
		$(document).ready(function(){
			...
			Highcharts.chart('comparisonchartmt', {

				title: {
					text: 'Sales Person History MT'
				},
