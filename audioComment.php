	<!--<script src="quotation/assets/vendor/recorderjs/patch.js"></script>-->
<!DOCTYPE html>
<html>
  <head>
  ...
  <body id="index" onload="">
    ...
    <script type="text/javascript" src="quotation/assets/vendor/recorderjs/js/jquery.min.js"></script>
    <script type="text/javascript" src="quotation/assets/vendor/recorderjs/js/mp3recorder.js"></script>
