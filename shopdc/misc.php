<?php
	...
	function reorderlines($orderno, $db){
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			//update line index
			$SQL = "UPDATE sdclines SET lineno='".$newLineIndex."'
					WHERE lineindex='".$row['lineindex']."'";

			mysqli_query($db, $SQL);

			//GET Line Options
			$SQL = "SELECT * FROM sdcoptions 
			...
			while($optionsRow = mysqli_fetch_assoc($lineOptionsResult)){
				...
				$SQL = "UPDATE sdcdetails SET orderlineno='".$newLineIndex."'
						WHERE orderno='".$orderno."'
			...
			$SQL = "UPDATE sdcoptions SET lineno='".$newLineIndex."'
					WHERE orderno='".$orderno."'
					AND lineno='".$row['lineno']."'";
